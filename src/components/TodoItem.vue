...
<!-- <template>
    ...
    <div class="row my-3 justify-content-between align-items-center">
        ...
        <div class="row align-items-center">
        <button @click="updateTodoI(todo)" class="col-sm-2 btn btn-primary mx-2">Edit</button>
        <button @click="deleteTodoI(todo.id)" class="col-sm-3 btn btn-danger">Delete</button>
    </div>
    </div>
</div>
</template>
